...
type nilMarshal struct{}

func (nilMarshal) MarshalJSON() ([]byte, error) { return nil, nil }

func TestNilMarshal(t *testing.T) {
	var s struct {
		NM nilMarshal `json:"nm,omitempty"`
	}
	want := []byte("{}")
	b, err := Marshal(s)
	if err != nil {
		t.Fatal("failed to Marshal MarshalJSON:", err)
	}
